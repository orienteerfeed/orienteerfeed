...
const HeroSection = () => {
  return (
    <section className="text-center md:mt-8 2xl:mt-10 pb-4 increase-margin-top">
      <AnimatedText
    ...
    <>
      ...
      <div className="absolute inset-0 overflow-hidden z-0">
        <img
          ...
          alt="Forest"
          className="absolute bottom-[42vh] max-h-[40vh] md:bottom-[54vh] 2xl:bottom-[46vh] w-full 2xl:max-h-[40vh] object-cover hide-on-small-ratio"
        />
        <Link to={PATHNAMES.event()}>
          <Tooltip content="Live results for every competitor and fan">
            <img
              ...
              alt="Arena"
              className="absolute bottom-[25vh] left-[60vw] w-[40vw] md:bottom-[30vh] md:w-[38vw] lg:bottom-[36vh] lg:left-[55vw] lg:w-[30vw] 2xl:bottom-[30vh] 2xl:left-[55vw] 2xl:w-[20vw] transform -translate-x-1/2 object-cover transition-transform duration-300 ease-in-out hover:scale-105 z-20"
            />
          </Tooltip>
        </Link>
        ...
        <Tooltip content="Last-minute registrations from anywhere">
          <img
            ...
            alt="Entries"
            className="absolute bottom-[9vh] right-[-7vw] w-[24vw] lg:bottom-[12vh] lg:right-[-4vw] lg:w-[20vw] 2xl:bottom-[10vh] 2xl:right-[11vw] 2xl:w-[14vw] transform -translate-x-1/2 object-cover transition-transform duration-300 ease-in-out hover:scale-105 z-20"
          />
        </Tooltip>
        <img
          src="/images/illustration/2025_orienteerfeed_v03_radio.svg"
          alt="Radio"
          className="absolute bottom-[45vh] left-[35vw] w-[17vw] md:bottom-[59vh] 2xl:bottom-[54vh] 2xl:left-[36vw] 2xl:w-[15vw] transform -translate-x-1/2 object-cover transition-transform duration-300 ease-in-out hover:scale-105 z-20 hide-on-small-ratio"
        />
        <Link to={PATHNAMES.getFeature('start')}>
          <Tooltip content="Receive changes from the start line">
            <img
              ...
              alt="Start"
              className="absolute bottom-[32vh] right-[-17.5vw] w-[38vw] md:bottom-[38vh] lg:bottom-[36vh] lg:right-[-13vw] lg:w-[32vw] 2xl:bottom-[25vh] 2xl:right-[-7.5vw] 2xl:w-[25vw] transform -translate-x-1/2 object-cover transition-transform duration-300 ease-in-out hover:scale-105 z-20"
            />
          </Tooltip>
        </Link>
        <Link to={PATHNAMES.getFeature('it')}>
          <Tooltip content="Sync updates with event management software">
            <img
              ...
              alt="IT Centrum"
              className="absolute bottom-[2vh] left-[52vw] w-[18vw] md:left-[56vw] lg:left-[49vw] lg:w-[16vw] 2xl:bottom-[7vh] 2xl:left-[37vw] 2xl:w-[13vw] transform -translate-x-1/2 object-cover transition-transform duration-300 ease-in-out hover:scale-105 z-20"
            />
          </Tooltip>
        </Link>
        <Link to={PATHNAMES.mrb()}>
          <Tooltip content="Project live results onto screens">
            <img
              ...
              alt="Results"
              className="absolute bottom-[16vh] left-[59vw] w-[18vw] md:bottom-[18vh] md:w-[16vw] lg:bottom-[20vh] lg:left-[55vw] lg:w-[12vw] 2xl:bottom-[11vh] 2xl:left-[55vw] 2xl:w-[11vw] transform -translate-x-1/2 object-cover transition-transform duration-300 ease-in-out hover:scale-105 z-20"
            />
          </Tooltip>
        </Link>
        <img
