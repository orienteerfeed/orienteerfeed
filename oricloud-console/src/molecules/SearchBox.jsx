    ...
    <div ref={searchRef} className="flex h-full">
      <div className="flex h-full items-center rounded-full bg-blue-50 text-zinc-700 dark:bg-zinc-800 dark:text-white xl:w-[225px] px-3">
        ...
        <input
          ...
          className="h-full w-full bg-blue-50 text-sm font-medium text-zinc-700 focus:outline-none placeholder:!text-gray-400 dark:bg-zinc-800 dark:text-white dark:placeholder:!text-white"
        />
      </div>

      {/* Search Results Dropdown */}
      {isOpen && data?.searchEvents?.length > 0 && (
        <div className="absolute top-20 -left-20 z-50 w-[360px] sm:w-[460px] flex flex-col gap-3 rounded-[20px] bg-white p-4 shadow-xl shadow-shadow-500 dark:!bg-zinc-700 dark:text-white dark:shadow-none transition-all duration-300 ease-in-out">
      ...
      {/* Loading State */}
      {loading && (
        <div className="absolute top-20 -left-20 z-50 w-[360px] sm:w-[460px] flex flex-col gap-3 rounded-[20px] bg-white p-4 shadow-xl shadow-shadow-500 dark:!bg-zinc-700 dark:text-white dark:shadow-none transition-all duration-300 ease-in-out text-center">
